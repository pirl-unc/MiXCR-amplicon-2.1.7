...
public class TaxFilter {
	...
	public static TaxFilter makeFilter(String[] args){
		...
		TaxFilter filter=new TaxFilter(tableFile, treeFile, accessionFile, taxLevel, reqLevel, include, null, regex, contains);
	 ...
	 * @param taxSet_
	 */
	public TaxFilter(String tableFile, String treeFile, String accessionFile, int taxLevel_, int reqLevel_, boolean include_, HashSet<Integer> taxSet_, String regex_, String contains_){
		taxLevel=taxLevel_;
		reqLevels=reqLevel_;
		include=include_;
		taxSet=(taxSet_==null ? new HashSet<Integer>() : taxSet_);
