...
public class MergeSamples {
	...
	public void mergeSamples(ArrayList<Sample> list, ScafMap scafMap, String outVcf, String scoreHistFile){
		...
		mergeFiles(vcfList, scafMap, outVcf, scoreHistFile);
	}
	
	public void mergeFiles(ArrayList<StringPair> list, ScafMap scafMap, String outVcf, String scoreHistFile){
...
//		System.err.println("Closed stream.");
	...
	void processHeader(byte[][] lines, ByteBuilder bb){
		...
		if(matrix[0][0].equals("##ploidy")){
			...
			bb.append("##properPairRate="+String.format("%.4f\n", properPairRate));
			...
			bb.append("##totalQualityAvg="+String.format("%.4f\n", totalQualityAvg));
			...
			bb.append("##mapqAvg="+String.format("%.2f\n", mapqAvg));
			...
			bb.append("##readLengthAvg="+String.format("%.2f\n", readLengthAvg));
