...
//			System.err.println("Loaded "+kmers+" kmers in "+tload);
		...
		System.err.println("Mode:                \t"+Tools.calcModeHistogram(histTotal));
		
		System.err.println();
		System.err.println("Insert range:        \t"+insertMinTotal+" - "+insertMaxTotal);
		System.err.println("90th percentile:     \t"+Tools.percentileHistogram(histTotal, .9));
		System.err.println("75th percentile:     \t"+Tools.percentileHistogram(histTotal, .75));
		System.err.println("50th percentile:     \t"+Tools.percentileHistogram(histTotal, .5));
		System.err.println("25th percentile:     \t"+Tools.percentileHistogram(histTotal, .25));
		System.err.println("10th percentile:     \t"+Tools.percentileHistogram(histTotal, .1));
	}
